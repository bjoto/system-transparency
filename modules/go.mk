...
ifeq ($(patsubst "%",%,$(ST_DEVELOP)),1)
	...
	touch $@
$(debos_bin) debos$(GROUP_TARGET): $(debos_checkout)
...
ifeq ($(patsubst "%",%,$(ST_DEVELOP)),1)
	...
	touch $@
$(u-root_bin) u-root$(GROUP_TARGET): $(u-root_checkout)
	$(call go_update,u-root,$(u-root_bin),$(u-root_package))
$(stmanager_bin) stmanager$(GROUP_TARGET): $(u-root_checkout)
	$(call go_update,stmanager,$(stmanager_bin),$(u-root_package)/tools/stmanager)

### cpu command

$(cpu_bin) $(cpud_bin) cpu$(GROUP_TARGET):
...
$(sinit-acm-grebber_bin) sinit-acm-grebber$(GROUP_TARGET):
